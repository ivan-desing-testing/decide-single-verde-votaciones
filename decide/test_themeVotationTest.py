...
class TestThemeVotationTest():
  ...
  def test_themeVotationTest(self):
    ...
    assert self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").text == "Electoral"
    ...
    locator = "option[@value='{}']".format(element.get_attribute("value"))
    selected_text = element.find_element(By.XPATH, locator).text
    assert selected_text == "Self-interest"
    self.driver.find_element(By.NAME, "_save").click()
    self.driver.find_element(By.LINK_TEXT, "Self-interest").click()
    self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").text == "Self-interest"
    self.driver.find_element(By.CSS_SELECTOR, "ul:nth-child(5) > li:nth-child(1) > a").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_name").click()
    self.driver.find_element(By.ID, "id_name").send_keys("PruebaSelenium1")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").text == "Knowledge"
    self.driver.find_element(By.CSS_SELECTOR, "ul:nth-child(5) > li:nth-child(1) > a").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_name").click()
    self.driver.find_element(By.ID, "id_name").send_keys("PruebaSelenium")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").text == "Testing"
    self.driver.find_element(By.CSS_SELECTOR, "ul:nth-child(5) > li:nth-child(1) > a").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_name").click()
    self.driver.find_element(By.ID, "id_name").send_keys("PruebaSelenium")
    ...
    dropdown = self.driver.find_element(By.ID, "id_auths")
    dropdown.find_element(By.XPATH, "//option[. = 'http://localhost:8000']").click()
    assert self.driver.find_element(By.ID, "id_themeVotation").text == "  ---------\\\\n  Electoral\\\\n  Self-interest\\\\n  Knowledge\\\\n  Testing\\\\n  Survey"
    self.driver.find_element(By.NAME, "_save").click()
    self.driver.find_element(By.LINK_TEXT, "Survey").click()
    self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").click()
    assert self.driver.find_element(By.CSS_SELECTOR, ".row1:nth-child(1) > .field-themeVotation").text == "Survey"
    self.driver.find_element(By.CSS_SELECTOR, "ul:nth-child(5) > li:nth-child(1) > a").click()
