...
class AdminTestCase():
    ...
    #LOS SIGUIENTES TEST DEBEN SER EJECUTADOS CON LA BASE DE DATOS DE VOTACIONES VAC�A, YA QUE SE USAN LAS IDs DE LAS VOTACIONES CREADAS.
    
    #Test para comprobar que la gr�fica se genera en la votaci�n comenzada
    def test_grafica_ver(self):
        ...
        #Comprobando que se crea la gr�fica (aunque este vacia ya que no hay votos)
        self.driver.get("http://localhost:8000/visualizer/1/")
        self.driver.set_window_size(1778, 893)
        self.assertTrue( self.driver.find_element(By.CSS_SELECTOR, ".highcharts-title > tspan").text == "Gr�fica de: Votacion de prueba") 

    #Test para comprobar que la gr�fica NO se genera si la votaci�n no ha comenzado
    def test_NO_grafica(self):
        ...
        #Comprobando que NO se crea la gr�fica
        self.driver.get("http://localhost:8000/visualizer/2/")
        self.driver.set_window_size(1778, 893)
        self.assertTrue(self.driver.find_element(By.CSS_SELECTOR, "h2").text == "Votaci�n no comenzada")          