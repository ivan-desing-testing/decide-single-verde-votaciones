...
class TestTestScopeQuestion(StaticLiveServerTestCase):
  ...
  def test_testScopeQuestion(self):
    ...
    self.driver.find_element(By.ID, "id_desc").send_keys("¿Serías capaz de mentir a la cara?")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_desc").send_keys("¿Cómo se llamaba el cantante de Queen?")
    self.driver.find_element(By.ID, "id_scopes").click()
    dropdown = self.driver.find_element(By.ID, "id_scopes")
    ...
    self.driver.find_element(By.ID, "id_desc").send_keys("¿Cuál es el único mamífero capaz de poner huevos?")
    self.driver.find_element(By.ID, "id_options-0-number").click()
    self.driver.find_element(By.ID, "id_options-0-number").send_keys("1")
    self.driver.find_element(By.ID, "id_options-1-number").click()
    self.driver.find_element(By.ID, "id_options-1-number").send_keys("2")
    ...
    self.driver.find_element(By.ID, "id_options-2-number").send_keys("3")
    self.driver.find_element(By.ID, "id_options-0-option").click()
    self.driver.find_element(By.ID, "id_options-0-option").send_keys("León")
    self.driver.find_element(By.ID, "id_options-1-option").click()
    ...
    self.driver.find_element(By.NAME, "_save").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_desc").send_keys("¿A qué equipo pertenece el jugador Ferran Torres?")
    self.driver.find_element(By.ID, "id_scopes").click()
    dropdown = self.driver.find_element(By.ID, "id_scopes")
    ...
    self.driver.find_element(By.NAME, "_save").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_desc").send_keys("¿En que año se descubrió América?")
    self.driver.find_element(By.ID, "id_scopes").click()
    dropdown = self.driver.find_element(By.ID, "id_scopes")
    ...
    self.driver.find_element(By.NAME, "_save").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_desc").send_keys("¿Quién escribio el libro donde se narraban las aventuras de Don Quijote?")
    self.driver.find_element(By.ID, "id_scopes").click()
    dropdown = self.driver.find_element(By.ID, "id_scopes")
    ...
    self.driver.find_element(By.ID, "id_options-2-option").click()
    self.driver.find_element(By.ID, "id_options-2-option").send_keys("García Lorca")
    self.driver.find_element(By.NAME, "_save").click()
    self.driver.find_element(By.CSS_SELECTOR, ".addlink").click()
    self.driver.find_element(By.ID, "id_desc").send_keys("¿En qué continente está situada Madrid?")
    self.driver.find_element(By.ID, "id_scopes").click()
    dropdown = self.driver.find_element(By.ID, "id_scopes")
    ...
    self.driver.find_element(By.ID, "id_options-2-option").click()
    self.driver.find_element(By.ID, "id_options-2-option").send_keys("África")
    self.driver.find_element(By.NAME, "_save").click()
